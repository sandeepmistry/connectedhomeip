...
class TestLightingApp(unittest.TestCase):
    def setUp(self):
        ...
        self.chip_tool_instance = AvhInstance(
            self.avh_client, username=SSH_USERNAME, password=SSH_PASSWORD
        )
        ...
        self.lighting_app_ssh_client.exec_command(
    ...
    def test_commissioning_and_control(self):
        ...
        _, stdout, _ = self.chip_tool_ssh_client.exec_command(
            "./chip-tool pairing ble-wifi 17 Arm password 20202021 3840"
        )
